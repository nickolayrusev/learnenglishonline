...
public class CustomJacksonMessageConverter extends
	...
	protected void writeInternal(Object object, HttpOutputMessage outputMessage)
	    ...
	    JsonGenerator jsonGenerator =
	            objectMapper.getFactory().createJsonGenerator(outputMessage.getBody(), encoding);
	    ...
	    try {
	        ...
	        if (object == null) {
	        	...
	        	newMapper.writeValue(jsonGenerator, object); 
	        }
	    }
...
//	        logger.error("Could not write JSON: " + ex.getMessage());
	 ...
	 * {@link ObjectMapper#constructType(java.lang.reflect.Type)} or
	 * {@code ObjectMapper.getTypeFactory().constructType(type, contextClass)},
	 * but this can be overridden in subclasses, to allow for custom generic
